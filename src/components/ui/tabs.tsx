...
export function TabsTrigger({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex items-center justify-center whitespace-nowrap rounded-md px-3.5 py-1.5 text-xs font-semibold ring-offset-white transition-all cursor-pointer",
        isActive
